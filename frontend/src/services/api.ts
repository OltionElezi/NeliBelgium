...
export const invoiceApi = {
  ...
  getPdf: (id: number, lang?: string) =>
    api.get(`/invoices/${id}/pdf`, {
      params: { lang },
      responseType: "blob",
    }),
  send: (id: number, email?: string, lang?: string) =>
    api.post(`/invoices/${id}/send`, { email, lang }),
...
export const expenseApi = {
  ...
  getByWorker: (workerId: number, params?: any) =>
    api.get(`/workers/${workerId}/expenses`, { params }),
  create: (workerId: number, data: any) =>
    api.post(`/workers/${workerId}/expenses`, data),
...
export const trashApi = {
  ...
  permanentDelete: (type: string, id: number) =>
...
export const companyExpenseApi = {
  ...
  getSummary: (params?: any) =>
    api.get("/company-expenses/summary", { params }),
...
export const electricalProjectApi = {
  getAll: (params?: { clientId?: number }) =>
    api.get("/electrical-projects", { params }),
  ...
  addDiagram: (
    projectId: number,
    data: { name: string; type: string; diagramData?: any }
  ) => api.post(`/electrical-projects/${projectId}/diagrams`, data),
  updateDiagram: (
    projectId: number,
    diagramId: number,
    data: { name?: string; diagramData?: any; pageIndex?: number }
  ...
  getPdf: (id: number) =>
    api.get(`/electrical-projects/${id}/pdf`, { responseType: "blob" }),
};
