...
exports.getProjectPdf = exports.duplicateProject = exports.deleteDiagram = exports.updateDiagram = exports.addDiagram = exports.deleteProject = exports.updateProject = exports.createProject = exports.getProjectById = exports.getAllProjects = void 0;
const client_1 = require("@prisma/client");
const electricalPdfService_1 = require("../services/electricalPdfService");
...
const addDiagram = async (req, res) => {
    try {
        ...
        if (!Object.values(client_1.DiagramType).includes(type)) {
...
const getProjectPdf = async (req, res) => {
    try {
        ...
        // Generate PDF
        const pdfBuffer = await (0, electricalPdfService_1.generateElectricalPdf)(project, company);
...
exports.getProjectPdf = getProjectPdf;
//# sourceMappingURL=electricalProjectController.js.map