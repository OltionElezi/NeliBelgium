    ...
    try {
        ...
        const product = await prisma.product.create({
            data: {
                ...
                description,
                sku: sku || null,
                priceBuying: new client_1.Prisma.Decimal(priceBuying),
                priceSelling: new client_1.Prisma.Decimal(priceSelling),
                stock: stock || 0,
                unit: unit || 'stuk',
                category
            }
    ...
    try {
        ...
        const updatedProduct = await prisma.product.update({
            ...
            data: {
                ...
                description,
                sku: sku || null,
                priceBuying: priceBuying !== undefined ? new client_1.Prisma.Decimal(priceBuying) : undefined,
                priceSelling: priceSelling !== undefined ? new client_1.Prisma.Decimal(priceSelling) : undefined,
                stock,
                unit,
                category
            }
