...
exports.testEmailConnection = exports.sendInvoiceEmail = void 0;
...
const sendInvoiceEmail = async (invoice, company, recipientEmail) => {
    try {
        const transporter = createTransporter();
        // Generate PDF
        const pdfBuffer = await (0, pdfService_1.generateInvoicePdf)(invoice, company);
        // Determine recipient
